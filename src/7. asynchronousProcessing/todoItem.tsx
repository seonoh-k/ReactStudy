...
import { useItemActions } from "./useAxios";
import type { Todo } from "./itemStore";
  ...
  return (
    ...
    border border-gray-500 rounded-[5px] bg-gray-300 text-gray-700">
      ...
      : <div className="flex ml-3 space-x-2">
          {/* 체크박스 */}
          <input type="checkbox" onChange={onToggle} checked={item.isDone} className="w-7 h-7 accent-green-200" />
          {/* Item */}
